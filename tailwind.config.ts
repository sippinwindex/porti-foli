...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Your Viva Magenta luxury palette
        'viva-magenta': {
          50: '#fdf2f4',
          100: '#fce7ea',
          200: '#f9d0d9',
      ...
      fontFamily: {
        sans: ['Space Grotesk', 'Inter var', 'Inter', 'system-ui', 'sans-serif'],
      ...
      backgroundImage: {
        ...
        'gradient-luxury': 'linear-gradient(135deg, var(--viva-magenta), var(--lux-gold))',
