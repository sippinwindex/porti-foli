      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div 
              variants={slideUp}
              className="mt-6 h-16 flex items-center justify-center lg:justify-start"
            >
            ...
            <motion.p 
              variants={slideUp}
              className="mt-6 text-lg text-dark-600 dark:text-dark-300 max-w-2xl mx-auto lg:mx-0"
            >
            ...
            >
              ...
              <motion.button
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center px-8 py-4 border-2 border-primary-600 dark:border-primary-400 text-primary-600 dark:text-primary-400 font-semibold rounded-xl hover:bg-primary-50 dark:hover:bg-primary-900/20 transition-all duration-300"
              >
          ...
          {/* Right Column - Animated Avatar/Image */}
          <motion.div 
